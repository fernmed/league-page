/*   STEP 1   */
export const leagueID = "729387191150710784"; // your league ID
export const leagueName = "Bawse League"; // your league name
...
<p><iframe width='65%' height='410' src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTbzcgFJC1MigKvKdrZjEdDOyBqLkLq8Fz2Ya1Icyn9-YKTfTL5fI71wS0OU0qW4Xm6HHEbYeIXDFHo/pubhtml?gid=0&amp;single=true&amp;widget=true&amp;headers=false"></iframe></p>
`;
...
export const managers = [
    {
      ...
      "bio": "The Commish. Best drafter in Bawse League history. Building for the future.",
      ...
      "philosophy": "Going for the championship, unless I'm losing two straight. Then it's for the future.",
      "tradingScale": 4, // 1 - 10
    ...
    },
    {
      ...
      "name": "Reuben R",
      "tookOver": null, // (optional) used if a manager took over a team, delete this line or change to null otherwise
      "location": "Deland", // (optional)
      "bio": "Co-Commish. Most fashionable member of Bawse. Loves a good taco. He's busy.",
      "photo": "/managers/name.jpg", // square ratio recommended (no larger than 500x500)
    ...
    },
    {
      ...
      "bio": "Loves sugar booger. Will swindle you for draft picks. Not a tanker.",
      "photo": "/managers/name.jpg", // square ratio recommended (no larger than 500x500)
      "fantasyStart": null, // (optional) when did the manager start playing fantasy football
